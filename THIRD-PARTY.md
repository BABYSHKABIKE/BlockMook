...
В `assets/signal-root.cer` находится публичный сертификат центра Signal Messenger из [официальной конфигурации Signal Desktop](https://github.com/signalapp/Signal-Desktop/blob/28a0430c59535d3cf2cf8e07e54b1be32d623eb9/config/default.json). Он применяется только для проверки TLS узлов Signal внутри BlockMook, без установки в Windows. Исходный код клиента Signal не включён. Происхождение и SHA-256 приведены в [документации сервисов](docs/services.md).
