...
internal static partial class Tests {
    ...
    private static void TestUpdates() {
        ...
        foreach(string invalid in new[]{"1.0","v1.2.3-beta","../1.2.3","v01.2.3","999999999999.1.0","1.2.3.4"})Check("Reject invalid release version "+invalid,Rejected(()=>Updates.ReadVersion(invalid)));
